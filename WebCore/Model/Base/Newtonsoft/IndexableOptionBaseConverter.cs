...
{
    internal class IndexableOptionBaseConverter : WriteOnlyConverterNewtonsoft<Desired.IndexableOptionBase>
    {
        public override void WriteJson(JsonWriter writer, Desired.IndexableOptionBase value, JsonSerializer serializer)
        {
            try
            {
